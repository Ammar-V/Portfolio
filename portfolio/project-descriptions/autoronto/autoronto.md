...
![Artemis: the self-driving car developed on by aUToronto](highway.jpeg)
*Source: aUToronto*
<br></br>
...
![A visualization of a 3D Point Cloud measured by a Cepton LiDAR](cepton.png)
...
![A visualization of point clouds generated by 3D LiDARs](lidar_large.gif)
...
![Detection 3D objects using clustering in a driving scene at a aUToronto](3dod.gif)
