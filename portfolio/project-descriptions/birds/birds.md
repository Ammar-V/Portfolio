...
![Animating birds using GANs](bird.gif)\
...
![A flowchart illustrating the bird animation pipeline](flowchart_overview.png)\
...
![A flowchart describing our data collection and processing pipeline](flowchart_processing.jpg)\
...
![A visual representation of model architecture behind DCGAN](DCGAN.png)\
...
![Output of a DCGAN trained on bird images](dcgan_results.png)\
...
![Five images of randomly generated birds](rand_gen.png)\
...
![A visual representation of style mixing](style_mixing.png)\
*Visual results created from the style mixing operator*
<br></br>

### Animation pipeline

![An overview of the animation pipeline used to go from an image of a bird to a video of that bird flying](animation_pipeline.png)\
*The animation pipeline that samples from a learned smooth data distribution*
<br></br>


![A representation of the output frames from the bird animation pipeline](flying_sequence.png)\
